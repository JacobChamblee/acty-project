...
import { API_BASE, API_ENDPOINTS, getApiConfig } from "./config";

// ── CONFIG — API configuration loaded from config.js and environment variables ──────
// REACT_APP_API_URL can be set in .env file for production deployment
